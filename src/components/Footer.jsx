    ...
    <footer className="bg-gray-900 text-gray-300 pt-16 pb-8 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-white tracking-tight">Care.xyz</span>
            </Link>
            <p className="text-gray-400 leading-relaxed">
              Connecting families with trusted caregivers since 2024. 
              Safety, reliability, and love are at the heart of everything we do.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Find a Sitter', 'Post a Job', 'How it Works', 'Safety & Trust', 'Pricing Plans'].map((item) => (
                <li key={item}>
                  <Link href="#" className="hover:text-rose-500 transition-colors flex items-center">
          ...
          {/* For Caregivers */}
          <div>
            <h3 className="text-white font-bold text-lg mb-6">For Caregivers</h3>
            <ul className="space-y-4">
              {['Apply to Sit', 'Sitter Resources', 'Insurance & Benefits', 'Success Stories', 'Community'].map((item) => (
                <li key={item}>
                  <Link href="#" className="hover:text-rose-500 transition-colors flex items-center">
                    <span className="w-1.5 h-1.5 bg-rose-600 rounded-full mr-2 opacity-0 hover:opacity-100 transition-opacity"></span>
                    {item}
          ...
          <div>
            ...
            <ul className="space-y-6">
              <li className="flex items-start">
                ...
                <span>123 Caregiver Lane,<br />San Francisco, CA 94105</span>
              </li>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <div>
            &copy; {currentYear} Care.xyz Inc. All rights reserved.
          </div>
