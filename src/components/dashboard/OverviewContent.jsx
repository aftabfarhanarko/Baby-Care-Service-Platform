  ...
  const recentActivity = [
    {
      ...
      description: "Your booking with Sarah Johnson was confirmed",
      time: "2 hours ago",
    },
    {
      id: 2,
      action: "New message",
      description: "You received a message from Emily Davis",
      time: "5 hours ago",
    },
    {
      id: 3,
      action: "Payment successful",
      description: "Payment for booking #1234 was successful",
      time: "1 day ago",
    },
  ];
