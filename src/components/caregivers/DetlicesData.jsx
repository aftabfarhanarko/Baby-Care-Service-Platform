          ...
          >
            ...
            <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-3xl p-4 shadow-xl dark:shadow-2xl relative overflow-hidden group">
              ...
              <div className="mt-6 text-center pb-2">
                ...
                <p className="text-rose-600 dark:text-rose-400 font-medium text-lg mt-1">{caregiver.role}</p>
            ...
            <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-3xl p-6 shadow-xl">
                <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200">Quick Information</h3>
                <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
                        ...
                        <span className="font-bold text-gray-900 dark:text-white">{caregiver.experience}</span>
                    </div>
                    <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
                        <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-gray-900 dark:text-white">${caregiver.rate}/hr</span>
                    </div>
                    <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
                        <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-gray-900 dark:text-white">{caregiver.rating} ({caregiver.reviews})</span>
                    </div>
                </div>
          ...
          >
            ...
            <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-3xl p-8 shadow-xl">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">About {caregiver.name.split(' ')[0]}</h2>
                </div>
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h4 className="font-semibold text-gray-900 dark:text-white">Verified Background</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Fully vetted and background checked</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400 mt-1" />
                        <div>
                            <h4 className="font-semibold text-gray-900 dark:text-white">Certified Professional</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Holds relevant certifications</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div key={review.id} className="p-4 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
                            ...
                            <div className="flex items-center gap-1 mb-2">
                                {[...Array(5)].map((_, i) => (
                                    <Star 
                                        key={i} 
                                        className={`w-4 h-4 ${i < review.rating ? 'text-yellow-500 dark:text-yellow-400 fill-yellow-500 dark:fill-yellow-400' : 'text-gray-300 dark:text-gray-600'}`} 
                                    />
                                ))}
                            </div>
